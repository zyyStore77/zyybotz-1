...
const starts = async (ikyy = new WAConnection()) => {
	...
	console.log(color(figlet.textSync('ZYY BOTV1', {
		font: 'Standard',
	...
	console.log(color('[Scurity dony]', 'cyan'), color('Owner is online now!', 'yellow'))
	console.log(color('[Scurity dony]', 'cyan'), color('Welcome back, Owner! Hope you are doing well~', 'yellow'))
	ikyy.browserDescription = ["Zyy - BOT", "Firefox", "3.0.0"];
	...
	ikyy.on('connecting', () => {
		console.log(color('[ DONY GANS ]', 'cyan'), color('Menghubungkan....'));
	})

	//connect
	ikyy.on('open', () => {
		console.log(color('[ DONY GANS ]', 'cyan'), color('Bot Sudah Online!'));
	})
